...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("JamSandwich", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("JamSandwich", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "JamSandwich";
		app.meta["name"] = "JamSandwich";
		app.meta["packageName"] = "com.sample.jamsandwich";
